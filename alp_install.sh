...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='alp.conf'
CONFIGFOLDER='/root/.AlphaCoin'
COIN_DAEMON='alpd'
COIN_CLI='alp-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/alp-project/AlphaCoin/releases/download/v1.0.0/alp-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='Alp'
COIN_PORT=52335
RPC_PORT=52334
